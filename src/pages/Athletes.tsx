...
const Athletes = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-white to-pickle dark:from-gray-900 dark:to-black text-gray-900 dark:text-gray-100 relative">
        <div className="container mx-auto px-4 py-10">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8">
            <h1 className="text-5xl font-extrabold text-center mb-6 text-pickle dark:text-pickle drop-shadow-lg">
              Athlete Leaderboard
            </h1>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
              <input
                ...
                className="w-full md:w-1/3 px-5 py-3 rounded-full bg-gray-100 dark:bg-gray-800 shadow-md focus:outline-none focus:ring-2 focus:ring-pickle"
              />
              ...
              <div className="flex gap-3 flex-wrap justify-center md:justify-start">
                <select
                  ...
                  className="px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800 shadow-md focus:outline-none focus:ring-2 focus:ring-pickle"
                >
                ...
                <table className="w-full table-auto text-sm">
                  <thead className="bg-pickle dark:bg-pickle text-white">
                    <tr>
                      ...
                      <th className="p-4 text-left">DUPRID</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    {filteredAthletes.map((athlete, index) => (
                      ...
                      >
                        <td className="p-4 text-xl font-extrabold text-black  dark:text-white">
                          {index + 1}
                        </td>
                        ...
                        <td className="p-4 font-semibold text-pickle dark:text-pickle">
                          {athlete.points}
                        </td>
                      </tr>
                    ))}
