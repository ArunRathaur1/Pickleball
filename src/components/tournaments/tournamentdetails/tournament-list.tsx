        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3">
          {tournaments.length > 0 ? (
                ...
                <div className="p-4 flex-grow flex flex-col">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center text-gray-600 group-hover:text-gray-700 transition-colors">
                      <div className="w-6 h-6 bg-pickle rounded-full flex items-center justify-center mr-2">
                        <span className="text-pickle text-xs">📍</span>
                      </div>
            ...
            <div className="col-span-full flex flex-col items-center justify-center py-20 text-center">
              <div className="w-24 h-24 bg-gradient-to-br from-pickle to-emerald-100 rounded-full flex items-center justify-center mb-6 shadow-lg">
